quero oque faças algo extremamente profissional separa esse server por modulos nao deixa tudo junto quero arquivos para gerenciar de cada coisa login autenticacao cadastro recupercao de senha edicao de perfil atualizacao de daos de perfil num arquivo e assim sucessivamente /**
 * =================================================================================================
...
server.listen(PORT, '0.0.0.0', () => {
    ...
    ============================================================
    `);
}); sem erros semfalhas sem implemtar funcoe que nao existem e sem fazer nada errado
